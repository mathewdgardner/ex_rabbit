defmodule ExRabbit.Application do
  @moduledoc """
    The ExRabbit application is the root its supervision tree. It supervises:
      ...
      * ExRabbit.Consumer.WorkerSupervisor - A Supervisor that spawns GenServers to handle messages from a consumer
